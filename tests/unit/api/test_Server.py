...
class test_Server(TestCase):
    ...
    def test_routes(self):
        ...
        assert self.server.routes() == {  '/'                                                    : { 'methods': {'GET' }, 'name': 'root'                                , 'path_format': '/'                                                    },
                                          ...
                                          '/pre-processor/mount_minio_bucket_as_hd2'             : { 'methods': {'POST'}, 'name': 'mount_minio_bucket_as_hd2'           , 'path_format': '/pre-processor/mount_minio_bucket_as_hd2'             },
                                          '/pre-processor/umount_minio_hd2'                      : { 'methods': {'POST'}, 'name': 'umount_minio_hd2'                    , 'path_format': '/pre-processor/umount_minio_hd2'                      },
