...
class test_Server(TestCase):
    ...
    def test_routes(self):
        ...
        assert self.server.routes() == {  '/'                                                    : { 'methods': {'GET' }, 'name': 'root'                                , 'path_format': '/'                                                    },
                                          ...
                                          '/configuration/clear_elastic_file_analysis/'          : { 'methods': {'PUT' }, 'name': 'clear_elastic_file_analysis'         , 'path_format': '/configuration/clear_elastic_file_analysis/'          },
                                          ...
                                          '/pre-processor/download_and_pre_process_a_zip_file'   : { 'methods': {'POST'}, 'name': 'download_and_pre_process_a_zip_file' , 'path_format': '/pre-processor/download_and_pre_process_a_zip_file'   },
                                          '/pre-processor/mark-all-hd2-files-unprocessed'        : {'methods' : {'POST'}, 'name': 'mark_all_hd2_files_unprocessed'      , 'path_format': '/pre-processor/mark-all-hd2-files-unprocessed'        },
                                          ...
                                          '/pre-processor/start-hd1-watcher-thread'              : { 'methods': {'POST'}, 'name': 'start_hd1_watcher_thread'            , 'path_format': '/pre-processor/start-hd1-watcher-thread'              },
                                          '/pre-processor/stop-hd1-watcher-thread'               : { 'methods': {'POST'}, 'name': 'stop_hd1_watcher_thread'             , 'path_format': '/pre-processor/stop-hd1-watcher-thread'               },
